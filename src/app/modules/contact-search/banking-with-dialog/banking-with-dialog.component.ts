...
@Component({
  selector: 'app-banking-with-dialog',
  templateUrl: './banking-with-dialog.component.html',
  styleUrls: ['./banking-with-dialog.component.css']
})
export class BankingWithDialogComponent implements OnInit {
  private readonly matDialogRef: MatDialogRef<BankingWithDialogComponent>;
  ...
  constructor(matDialogRef: MatDialogRef<BankingWithDialogComponent>,
